...
if __name__ == '__main__':
    # Pull_File("E:/Semester 5/Iot Course/Final Report/Final Report.pdf")
    # Pull_File("E:/Semester 5/Iot Course/Final Report/Final Report.docx")
    search = Search(collection)
    search.search_contents("iot")
    # delete_file("Final Report.docx")